...
func Test_HandlerError_EndpointReturnsInternalError(t *testing.T) {
	assert := assert.New(t)
...
func Test_HandlerError_EndpointReturnsDomainError(t *testing.T) {
	assert := assert.New(t)
	endpoint := func(w http.ResponseWriter, r *http.Request) (interface{}, int, error) {
...
func Test_HandlerError_EndpointReturnsObjectAndStatus(t *testing.T) {
	assert := assert.New(t)
